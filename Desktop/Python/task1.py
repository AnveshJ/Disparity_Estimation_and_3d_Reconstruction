...
def disparity_depth_estimation(root, subj, task)
	...
	for n in range(0,len(images1)):
		...
		scipy.misc.imsave('/Users/anveshjadon/Desktop/Python/depth_task1/' + 'depth_frame_%d.bmp'%n, depth_list)
		scipy.misc.imsave('/Users/anveshjadon/Desktop/Python/disparity_task1/' + 'disp_frame_%d.bmp'%n, disp_list)
		# Final Display
		#imshow(disp_list)
